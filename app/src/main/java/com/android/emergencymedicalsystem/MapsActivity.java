...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String lat,lng,driverLatitude,driverLongitude;
    double passenger_lat,passenger_lng,driver_lat,driver_lng;
    @Override
...
//Fetching latitude, longitude from shared preferences
        driverLatitude = sharedPreferences.getString(Constant.LATITUDE_SHARED_PREF,"Not Available");
        driverLongitude = sharedPreferences.getString(Constant.LONGITUDE_SHARED_PREF, "Not Available");

        lat=getIntent().getExtras().getString("lat");
        lng=getIntent().getExtras().getString("lng");

        passenger_lat= Double.parseDouble(lat);
        passenger_lng= Double.parseDouble(lng);
        driver_lat= Double.parseDouble(driverLatitude);
        driver_lng= Double.parseDouble(driverLongitude);

        mOrigin = new LatLng(driver_lat, driver_lng);
        mDestination = new LatLng(passenger_lat, passenger_lng);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(mOrigin).title("Driver"));
        mMap.addMarker(new MarkerOptions().position(mDestination).title("Passenger"));
    ...
    public class TaskParseDirection extends AsyncTask<String, Void, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> lists) {
            ...
            if (polylineOptions != null) {
                ...
                Toasty.info(getApplicationContext(), "View passenger location from map.", Toasty.LENGTH_LONG).show();
            }
        }
    }
